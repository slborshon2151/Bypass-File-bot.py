import telebot # ছোট হাতের i করা হয়েছে
...
# আপনার বটের টোকেন (নিরাপত্তার জন্য এটি কাউকে শেয়ার করবেন না)
...
if __name__ == "__main__":
    keep_alive()
    # কনফ্লিক্ট এড়াতে পুরোনো সেশন রিমুভ করা হয়েছে
    bot.remove_webhook()
    # skip_pending ব্যবহার করা হয়েছে যাতে জমানো মেসেজ ইগনোর করে
